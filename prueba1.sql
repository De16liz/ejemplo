...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-09-2021 a las 19:25:57
...
(1, 'T1', 'D2', 'INSTALACIÓN'),
(2, 'T2', 'D21', '¿Quién puede hacer la instalación?'),
(3, 'P1', 'D211', 'Los perfiles que cumplen con la instalación son: un técnico en sistemas, un programador y un Analista-programador.'),
(4, 'P1', 'D211', 'Las locaciones adecuadas para la instalación, podrían ser en cualquier medio tecnológico que cumplan con los requerimientos; como los son Computador, Tablet o dispositivo móvil. Además, desde cualquier sala de cómputo, o simplemente desde la comodidad de su casa, si cuenta con los recursos para la instalación del traductor.'),
(5, 'T1', 'D3', 'RECOMENDACIONES'),
(6, 'P1', 'D31', 'Para evitar pérdidas por motivos mayores o catástrofes, es recomendable subir el software a un servidor web, donde se podrá alojar sin ningún problema y siempre estará disponible sin importar donde se encuentre.'),
(7, 'P1', 'D31', 'Constantemente el fluido eléctrico presenta fallas, es por esto que se recomienda usar una UPS, que se usa para alimentar a un equipo electrónico o eléctrico, Tiene un diseño interactivo, ahorradora de energía cuenta con auto reinicio cuando regresa la energía, protege su equipo de alti-bajos de energía y contra cortos circuitos. ... Protege tu equipo contra un apagón de energía.'),
(8, 'T1', 'D4', 'SEGURIDAD'),
(9, 'P1', 'D41', 'El mecanismo de seguridad que se usará, será por medio de una encriptación, para evitar que sea hurtada la información del contenido del software.'),
(10, 'P1', 'D41', 'Semanalmente se realizará una copia de seguridad, esto para evitar perdida de la información en caso de actualizaciones o cambios del mismo.'),
(11, 'P1', 'D41', 'Si presentan inconsistencias del software, se podrá realizar una restauración del contenido para reparar las anomalías.'),
(12, 'P1', 'D41', 'Estará alojado en el servidor de hosting, para que tenga el privilegio de la realización de las copias de seguridad.'),
(13, 'P1', 'D41', 'Toda imagen usada por el traductor, es de autoría de una de sus creadoras (Lizbeth Caro)'),
(14, 'T2', 'D412', 'LICENCIA'),
(15, 'P1', 'D4122', 'El copyright representa los derechos de autor que se le conceden a las creadoras del proyecto Traductor Nativo'),
(16, 'T1', 'D5', 'FORTALEZAS'),
(17, 'P1', 'D51', 'Desde los inicios de este proyecto, siempre se tuvo claro el tema central, enfocándonos en una de las necesidades que presenta la etnia indígena de panore en San José del Guaviare.'),
(18, 'P1', 'D51', 'Además de que una de las organizadoras y creadoras del proyecto es perteneciente de la etnia y tiene conocimiento de la lengua.'),
(19, 'P1', 'D51', 'Durante el proceso de este producto, se afianzaron temas y conocimientos, esto nos permitió realizar mejorías para un mejor desarrollo de nuestro proyecto, dando como resultado un excelente proceso y un terminado completo.'),
(20, 'T1', 'D6', 'DEBILIDADES'),
(21, 'P1', 'D61', 'La lengua del tucano ha perdido fuerza, y esto se debe a que muchos de los que pertenecen a la etnia, se han civilizado, y los que tienen un dominio de su propia lengua han venido falleciendo, dificultando la recolección de datos para seguir alimentando la base de datos. '),
(22, 'P1', 'D61', 'En cuanto a la programación y tecnologías, cada día van innovando, esto obliga a conocer diferentes formas de programar y conocer nuevas líneas de codificación, debilitando el proceso de mejoras del mismo.');
